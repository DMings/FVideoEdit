...
public class ShaderHelper {
    ...
    private static int compileShader(int type, String shaderCode) {
        ...
        if (shaderObjectId == 0) {
            ...
            // 返回值0代表着创建对象失败。
            FLog.e("Could not create new shader.");
            return 0;
        }
        ...
        // 打印编译的着色器信息
//        FLog.i( "Results of compiling source:" + "\n" + shaderCode + "\n:"
//                + GLES20.glGetShaderInfoLog(shaderObjectId));
        ...
        if (compileStatus[0] == 0) {
            ...
            FLog.e("Compilation of shader failed.");
            // 7.返回着色器对象：失败，为0
            return 0;
        }
    ...
    public static int linkProgram(int vertexShaderId, int fragmentShaderId) {
        ...
        if (programObjectId == 0) {
            FLog.e("Could not create new program");
            return 0;
        }
        ...
        // 打印链接信息
//            FLog.i("Results of linking program:\n"
//                    + GLES20.glGetProgramInfoLog(programObjectId));
        ...
        if (linkStatus[0] == 0) {
            ...
            FLog.e("Linking of program failed.");
            // 7.返回程序对象：失败，为0
            return 0;
        }
    ...
    private static boolean validateProgram(int programObjectId) {
        ...
        FLog.i("Results of validating program: " + validateStatus[0]
