...
public class EglHelper {
    ...
    public void initEgl(EGLContext eglContext, Object surface) {
        //1. 得到Egl实例
...
//            mEglSurface = mEgl.eglCreateWindowSurface(mEglDisplay, eglConfig,surface,null);
        ...
        FGLUtils.glCheckErr("eglCreateWindowSurface");
    }
    ...
    public boolean isEglCreate() {
        return (mEglDisplay != null && mEglSurface != null && mEglContext != null);
    }
