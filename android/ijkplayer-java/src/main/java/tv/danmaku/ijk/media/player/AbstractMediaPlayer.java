...
public abstract class AbstractMediaPlayer implements IMediaPlayer {
    ...
    private Runnable mOnSyncMediaVideoRenderingStartListener;
    ...
    public void setOnSyncMediaVideoRenderingStartListener(Runnable onSyncMediaVideoRenderingStartListener) {
        mOnSyncMediaVideoRenderingStartListener = onSyncMediaVideoRenderingStartListener;
    }
    ...
    protected final void notifySyncMediaVideoRenderingStart() {
        if (mOnSyncMediaVideoRenderingStartListener != null) {
            mOnSyncMediaVideoRenderingStartListener.run();
        }
    }
