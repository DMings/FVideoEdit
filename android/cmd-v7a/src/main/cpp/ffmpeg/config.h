...
#define FFMPEG_CONFIGURATION "--arch=arm --cpu=cortex-a8 --enable-neon --enable-thumb --disable-gpl --disable-nonfree --enable-runtime-cpudetect --disable-gray --disable-swscale-alpha --disable-programs --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-doc --disable-htmlpages --disable-manpages --disable-podpages --disable-txtpages --disable-avdevice --enable-avcodec --enable-avformat --enable-avutil --enable-swresample --enable-swscale --disable-postproc --enable-avfilter --enable-filter=boxblur --enable-gpl --disable-avresample --enable-network --disable-dxva2 --disable-vaapi --disable-vdpau --enable-encoders --enable-decoders --enable-hwaccels --enable-muxers --enable-demuxers --enable-parsers --enable-bsfs --enable-protocols --disable-devices --enable-filters --disable-iconv --enable-protocol=async --disable-bsf=eac3_core --disable-protocol=https --prefix=/home/dming/ijk/ijkplayer-android/android/contrib/build/ffmpeg-armv7a/output --cross-prefix=arm-linux-androideabi- --enable-cross-compile --target-os=linux --enable-pic --enable-asm --enable-inline-asm --enable-optimizations --enable-debug --enable-small --extra-cflags='-O3 -Wall -pipe -std=c99 -ffast-math -fstrict-aliasing -Werror=strict-aliasing -Wno-psabi -Wa,--noexecstack -DANDROID -DNDEBUG -march=armv7-a -mcpu=cortex-a8 -mfpu=vfpv3-d16 -mfloat-abi=softfp -mthumb' --extra-ldflags=' -Wl,--fix-cortex-a8'"
#define FFMPEG_LICENSE "GPL version 2 or later"
#define CONFIG_THIS_YEAR 2018
#define FFMPEG_DATADIR "/home/dming/ijk/ijkplayer-android/android/contrib/build/ffmpeg-armv7a/output/share/ffmpeg"
#define AVCONV_DATADIR "/home/dming/ijk/ijkplayer-android/android/contrib/build/ffmpeg-armv7a/output/share/ffmpeg"
